...
var pizzaElementGenerator = function(i) {
    ...
    /*
        Fixed Bug: Please read comments below 
    */
...
var resizePizzas = function(size) {
    ...
    /*
        Case selector below updates the pizzaSize attribute to display to user
    */
    ...
    /*
      Fixed Bug: Please read comments below, my comments are  are inline with code.
    */
    
    function changePizzaSizes(size) {
        var chosenPizza = document.getElementsByClassName("randomPizzaContainer"); // This selects all element selectors with .randomPizzaContainer
        var dx = determineDx(chosenPizza[0], size); // This selects all element selectors with .randomPizzaContainer
        var newWidth = (chosenPizza[0].offsetWidth + dx) + 'px'; // This selects all element selectors with .randomPizzaContainer
        for (var i = 0, len = chosenPizza.length; i < len; i++) { //This goes through each og the elements
            chosenPizza[i].style.width = newWidth; //This gives a  new width to the chosen pizza
        }
    }
    changePizzaSizes(size); // Executes pizza change
...
function logAverageFrame(times) { // times is the array of User Timing measurements from updatePositions()
    ...
    /*
      Fixed Bug: Please read comments below, my comments are inline with code.
    */
...
function updatePositions() {
    ...
    var movingPizza = document.querySelectorAll('.mover'); //This selects all items with .mover
